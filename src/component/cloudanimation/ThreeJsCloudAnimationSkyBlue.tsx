...
import smoke from "../../assets/ThreeJsCloudAnimationAssets/cloud.png";

const CloudAnimationSkyBlue: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loadertwo.load(
      ...
      (texture: THREE.Texture) => {
        const cloudGeometry = new THREE.PlaneGeometry(3000, 1200);
        const cloudMaterial = new THREE.MeshLambertMaterial({
          map: texture,
          transparent: true,
          color: new THREE.Color(0x3f6bbe),
          emissive: new THREE.Color(0x3f6bbe),
          emissiveIntensity: 0,
          alphaTest: 0.1,
          depthWrite: false,
        });
    ...
    loader.load(
      ...
      (texture: THREE.Texture) => {
        ...
        const cloudMaterial = new THREE.MeshLambertMaterial({
          map: texture,
          transparent: true,
          color: new THREE.Color(0x2873fe),
          emissive: new THREE.Color(0x2873fe),
          emissiveIntensity: 1,
        });
...
export default CloudAnimationSkyBlue;
